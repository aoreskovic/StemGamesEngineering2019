...
% y: referent base voltage [V]


% bufferPulley is the global buffer used for this function.
% Example: a = bufferPulley[4] assigns 4th element of the list to variable a
