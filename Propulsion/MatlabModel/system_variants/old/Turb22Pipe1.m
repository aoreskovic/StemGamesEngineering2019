...
turbineNR = 22; %selected turbine
pipeNR = 1; %selected pipe
pipeLength = 3.34; %evaporator and condenser, m
numberOfPipesEvap = 420; %number of tubes in evaporator
numberOfPipesSuper = 95;
evapRatio = 0.950303156447188;

AlphaEvapSteam =3500; 
AlphaSuperSteam = 70;

%compressor_params:
qnRetlow = 0.032339355396157;
