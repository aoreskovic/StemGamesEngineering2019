...
inline double trans2(double t, int coord_num, Measurement pos, Measurement vel, 
           Coords load_pos, Coords load_vel,
           Coords top_pos ,Coords top_vel)
{
    // buffer_trans2 is the global buffer used for this function.
    // Example: a = buffer_trans2[4] assigns 5th element of the list to variable a
