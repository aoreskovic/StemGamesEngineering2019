...
Cmp_H2O = cp('H2O', temperature); %[kJ/kmolK] water vapor molar specific heat capacity
Cmp_CO2 =  cp('CO2', temperature); %[kJ/kmolK] carbon dioxide molar specific heat capacity
