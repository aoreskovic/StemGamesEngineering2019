...
% odabir turbine
%Odabrani parametri:
turbine_nr = 1; %redni broj odabrane turbine
thetaFG_evap_in = 750; %temperatura dimnih plinova na ulazu u isparivac
thetaFG_evap_out = 220; %temperatura dimnih plinova na izlazu iz isparivaca
pipe_nr = 1;
wFGevapReq = 7; %m/s željena brzina strujanja dimnih plinova u isparivacu
NpumpNom = 0.8; %željena nominalna brzina pumpe
wFGsuperReq = wFGevapReq/3.8; %m/s željena brzina plinova u pregrijacu
...
Mfuel = 2*12+6+16;
qmFuel = qnFuel*Mfuel;
QpumpMax = qmFuel/789*3600*1000/0.8;
