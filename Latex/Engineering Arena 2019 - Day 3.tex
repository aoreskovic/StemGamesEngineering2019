...
Your main task for today is to control the submarine.  The main task of your 
submarine is to supply and maintain underwater habitats which means that the 
communication system between submarine and each habitat must be set. The 
submarine is able to navigate to the corresponding habitats using the 
continuous communication between the submarine and each habitat. The last task 
is to define the governing system which will control the submarine position.
