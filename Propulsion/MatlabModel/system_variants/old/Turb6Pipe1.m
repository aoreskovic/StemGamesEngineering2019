...
turbineNR = 6; %selected turbine
pipeNR = 1; %selected pipe
pipeLength = 3.34; %evaporator and condenser, m
numberOfPipesEvap = 56; %number of tubes in evaporator
numberOfPipesSuper = 11;
evapRatio = 0.955228681310539;

AlphaEvapSteam =3500; 
AlphaSuperSteam = 70;

%compressor_params:
qnRetlow = 0.004317980570932;
