...
turbineNR = 18; %selected turbine
pipeNR = 1; %selected pipe
pipeLength = 3.34; %evaporator and condenser, m
numberOfPipesEvap = 280; %number of tubes in evaporator
numberOfPipesSuper = 63;
evapRatio = 0.950251784107669;

AlphaEvapSteam =3500; 
AlphaSuperSteam = 70;

%compressor_params:
qnRetlow = 0.021560838054273;
