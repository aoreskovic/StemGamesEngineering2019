...
// returns: referent base voltage [V]
inline double pulley(double t, int coord_num, Measurement pos, Measurement vel, 
           Coords load_pos, Coords load_vel,
           Coords top_pos ,Coords top_vel)
{
    // buffer_pulley is the global buffer used for this function.
    // Example: a = buffer_pulley[4] assigns 5th element of the list to variable a
