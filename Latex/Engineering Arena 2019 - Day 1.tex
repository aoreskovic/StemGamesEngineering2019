...
\begin{document}
	...
	waters.
	Those submarines, alongside with the supplies, also transfer the habitat 
	crew, taking people to and from the the habitats, and rescuing them in the 
	...
	competition we decided to focus on few we foun the most interesting.
