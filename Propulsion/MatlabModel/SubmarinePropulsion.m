...
Sub.HE.Pipe.length = 3.29; %m, heat exchanger pipe length
Sub.HE.Evap.nr = 280;  % number of tubes in evaporator
Sub.HE.Super.nr = 63; % number of tubes in superheater section

%compressor parameters
Sub.Compr.id = 23; % selected compressor

%fuel pump parameters
Sub.Fuel.Pump.id = 13; %selected fuel pump
...
Sub.Compr.N1 = 0.91; %-, fuel pump relative speed at which compressor load is L1
...
%% INPUTS
pump_speed_vector = [ones(1,100)*0.91];
