function [a_ref, b_ref, c_ref, a_max, b_max, c_max, h_max, k, n_min, aP_ref, bP_ref, cP_ref, dP_ref, inverterP, aP_max, bP_max, cP_max, dP_max, Pmax] = fuel_pump_poz_par(Q_nom,h_nom, P_nom, pump_type)
